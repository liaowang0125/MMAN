...
# =============================================================================
    def set_input(self, input):
        ...
        original_size=(original_size[0].numpy()[0],original_size[1].numpy()[0])
        # print(original_size[0].numpy()[0],original_size[1].numpy()[0])
        #G1
    ...
    def get_current_visuals(self):
        ...
        real_A = util.tensor2im(self.real_A.data,self.original_size)
        fake_B = util.ndim_tensor2im(self.fake_B_GAN.data,self.original_size, dataset = self.opt.dataset)
        if self.isTrain:
            real_B = util.ndim_tensor2im(self.real_B_GAN.data, self.original_size,dataset = self.opt.dataset)
