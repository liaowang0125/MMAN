...
def tensor2im(image_tensor,original_size, imtype=np.uint8):
    #print(image_tensor)
    ...
    # print(original_size)
    image_pil=image_pil.resize(original_size)
    return image_pil

def ndim_tensor2im(image_tensor,original_size, imtype=np.uint8, dataset = 'PPSS', dim = 'L2'):
